            ...
            <div class="card-body p-lg-17">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-12 pe-lg-10">
                        <!--begin::Form-->
                        <form method="POST" action="{{ route('permissions.update', $permission->id) }}" class="form mb-15 fv-plugins-bootstrap5 fv-plugins-framework" method="post"
                            id="kt_contact_form">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="row mb-5">
                                ...
                                <div class="col-md-12 fv-row fv-plugins-icon-container mb-5">
                                    ...
                                    <!--begin::Input-->
                                    <input type="text" class="form-control form-control-solid  @if ($errors->has('name')) is-invalid  @endif" value="{{ old('name', $permission->name) }}" placeholder="Ingresar Nombre Del Permiso.."
                                        name="name">
                                    <!--end::Input-->
                                    @if ($errors->has('name'))
