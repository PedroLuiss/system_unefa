...
<div class="card">
    <div class="card-header border-0 pt-5">
        <h3 class="card-title align-items-start flex-column">
            <span class="card-label fw-bolder text-dark">Listas de expedientes - Lic. Administración</span>
        ...
        <div id="kt_table_users_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
            ...
            <tbody class="text-gray-600 fw-bold">
                ...
                <tr class="odd">
                    ...
                    <!--begin::Action=-->
                    <td class="text-end">
                        <a href="{{route('expedientes.administracion.edit',$value->id)}}" title="editar" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
