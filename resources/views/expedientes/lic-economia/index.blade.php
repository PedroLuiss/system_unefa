...
<div class="card">
    <div class="card-header border-0 pt-5">
        <h3 class="card-title align-items-start flex-column">
            <span class="card-label fw-bolder text-dark">Listas de expedientes - Lic. Economía</span>
    ...
    <div class="card-header border-0 pt-6">
        ...
        <div class="card-toolbar" data-select2-id="select2-data-133-a0zo">
            ...
            <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base" data-select2-id="select2-data-132-co2t">
                ...
                <!--begin::Add user-->
                <a href="{{route('expedientes.economia.create')}}" class="btn btn-primary" >
        ...
        <div id="kt_table_users_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
            ...
            <tbody class="text-gray-600 fw-bold">
                ...
                <tr class="odd">
                    ...
                    <!--begin::Action=-->
                    <td class="text-end">
                        <a href="{{route('expedientes.economia.edit',$value->id)}}" title="editar" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                        ...
                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true" style="">
                            ...
                            <div class="menu-item px-3">
                                <a href="{{route('expedientes.economia.edit',$value->id)}}" class="menu-link px-3">Edit</a>
                            </div>
                            <!--end::Menu item-->
                            <!--begin::Menu item-->
                            <div class="menu-item px-3">
