            ...
            <div class="card-body p-lg-17">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-12 pe-lg-10">
                        <!--begin::Form-->
                        <form action="{{route('user.store')}}" class="form mb-15 fv-plugins-bootstrap5 fv-plugins-framework" method="post"
                            id="kt_contact_form">
                            @csrf
                            ...
                            <div class="row mb-5">
                                ...
                                <div class="col-md-6 fv-row fv-plugins-icon-container">
                                    ...
                                    <!--begin::Input-->
                                    <input type="text" class="form-control form-control-solid  @if ($errors->has('name')) is-invalid  @endif" value="{{ old('name') }}" placeholder="Ingresar Nombre Completo.."
                                        name="name">
                                    <!--end::Input-->
                                    @if ($errors->has('name'))
                                ...
                                <div class="col-md-6 fv-row fv-plugins-icon-container">
                                    ...
                                    <!--end::Input-->
                                    <input type="text" class="form-control form-control-solid @if ($errors->has('cedula')) is-invalid  @endif" value="{{ old('cedula') }}"  placeholder="Ingresar Cédula.."
                                        name="cedula">
                                    <!--end::Input-->
                            ...
                            <div class="d-flex flex-column mb-5 fv-row">
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input class="form-control form-control-solid @if ($errors->has('email')) is-invalid  @endif" type="email" value="{{ old('email') }}" placeholder="Ingresar El Email.." name="email">
                                <!--end::Input-->
                                @if ($errors->has('email'))
                            ...
                            <div class="d-flex flex-column mb-5 fv-row">
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input class="form-control form-control-solid @if ($errors->has('password')) is-invalid  @endif" type="password" value="{{ old('password') }}" placeholder="Ingresar El password.." name="password">
                                <!--end::Input-->
