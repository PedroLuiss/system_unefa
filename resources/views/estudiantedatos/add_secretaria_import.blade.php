                    ...
                    <div class="card">
                        <div class="card-header border-0 pt-5">
                            ...
                            <h3 class="card-title align-items-start flex-column">
                                ...
                                <span class="text-muted fw-semibold fs-7">Asegurese que el archivo sea formato Excel</span>
                            </h3>
                            <!--end::Title-->
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('estudiantedatos.importdocexcel') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="input-group mb-3">
                                    <input type="file" class="form-control h-100" id="import_file" name="exceldocumento">
