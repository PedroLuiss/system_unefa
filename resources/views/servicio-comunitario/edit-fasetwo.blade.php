                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="mb-5">
                                ...
                                <div class="input-group flex-nowrap">
                                    ...
                                    <div class="flex-grow-1" data-select2-id="select2-data-99-jk2x">
                                        <input type="email" class="form-control " id="nombre_comunidad" value="{{$grupo->nombre_comunidad}}" placeholder="Ingresar Nombre De La Comunidad y/o Institución"/>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="direccion_comunidad" placeholder="Ingrese la Direccion de la comindad" rows="3">{{$grupo->direccion_comunidad}}</textarea>
                              </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-5">
                                ...
                                <div class="input-group flex-nowrap">
                                    ...
                                    <div class="flex-grow-1" data-select2-id="select2-data-99-jk2x">
                                        <input type="text" class="form-control " value="{{$grupo->nombre_tutor_comunitario}}" id="nomb_tutor_comunitario" placeholder="Ingresar el Nombre Del Tutor Comunitario"/>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-5">
                                ...
                                <div class="input-group flex-nowrap">
                                    ...
                                    <div class="flex-grow-1" data-select2-id="select2-data-99-jk2x">
                                        <input type="text" class="form-control " value="{{$grupo->cedula_tutor_comunitario}}" id="cedula_tutor_comunitario" placeholder="Ingresar el Cédula Del Tutor Comunitario"/>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-5">
                                ...
                                <div class="input-group flex-nowrap">
                                    ...
                                    <div class="flex-grow-1" data-select2-id="select2-data-99-jk2x">
                                        <input type="number" class="form-control " value="{{$grupo->telefono_tutor_comunitario}}" id="telefono_tutor_comunitario" placeholder="Ingresar el Telefono Del Tutor Comunitario"/>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-5">
                                ...
                                <div class="input-group flex-nowrap">
                                    ...
                                    <div class="flex-grow-1" data-select2-id="select2-data-99-jk2x">
                                        <input type="number" class="form-control " value="{{$grupo->cant_beneficiados}}" id="cant_beneficiados" placeholder="Ingresar la Cantidad De Beneficiados"/>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="mb-5">
                                ...
                                <div class="input-group flex-nowrap">
                                    ...
                                    <div class="flex-grow-1" data-select2-id="select2-data-99-jk2x">
                                        <input type="text" class="form-control " value="{{$grupo->vinc_project_planes_prog}}" id="vinculacion_project" placeholder="Ingresar la Cantidad De Beneficiados"/>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="card-body pt-0">
                    <div class="row">
                        <div class="col-6 col-md-3">
                            <div class="mb-5" data-select2-id="select2-data-100-kjmd">
                                <div class="form-check form-check-custom form-check-solid form-check-lg">
                                    <input class="form-check-input" type="checkbox" @if ($grupo->foros)   checked @endif  value="" id="foro_check"/>
                        ...
                        <div class="col-6 col-md-3">
                            <div class="mb-5" data-select2-id="select2-data-100-kjmd">
                                <div class="form-check form-check-custom form-check-solid form-check-lg">
                                    <input class="form-check-input" type="checkbox" @if ($grupo->charlas)   checked @endif  value="" id="charlas_check"/>
                        ...
                        <div class="col-6 col-md-3">
                            <div class="mb-5" data-select2-id="select2-data-100-kjmd">
                                <div class="form-check form-check-custom form-check-solid form-check-lg">
                                    <input class="form-check-input" type="checkbox" @if ($grupo->jornadas)   checked @endif  value="" id="jornadas_check"/>
                        ...
                        <div class="col-6 col-md-3">
                            <div class="mb-5" data-select2-id="select2-data-100-kjmd">
                                <div class="form-check form-check-custom form-check-solid form-check-lg">
                                    <input class="form-check-input" type="checkbox" @if ($grupo->talleres)   checked @endif  value="" id="talleres_check"/>
                        ...
                        <div class="col-6 col-md-3">
                            <div class="mb-5" data-select2-id="select2-data-100-kjmd">
                                <div class="form-check form-check-custom form-check-solid form-check-lg">
                                    <input class="form-check-input" type="checkbox" @if ($grupo->campanas)   checked @endif  value="" id="campana_check"/>
                        ...
                        <div class="col-6 col-md-3">
                            <div class="mb-5" data-select2-id="select2-data-100-kjmd">
                                <div class="form-check form-check-custom form-check-solid form-check-lg">
                                    <input class="form-check-input" type="checkbox"  @if ($grupo->reunion_misiones)   checked @endif value="" id="reunion_misiones_check"/>
                        ...
                        <div class="col-6 col-md-3">
                            <div class="mb-5" data-select2-id="select2-data-100-kjmd">
                                <div class="form-check form-check-custom form-check-solid form-check-lg">
                                    <input class="form-check-input" type="checkbox" @if ($grupo->ferias)   checked @endif  value="" id="ferias_check"/>
                        ...
                        <div class="col-6 col-md-3">
                            <div class="mb-5" data-select2-id="select2-data-100-kjmd">
                                <div class="form-check form-check-custom form-check-solid form-check-lg">
                                    <input class="form-check-input" type="checkbox" @if ($grupo->alianzas_estrategicas)   checked @endif  value="" id="alianzas_estrategicas_check"/>
            ...
            $.ajax({
             ...
             $('#btn-guardar-all-files-ing-sistema').on('click',(e)=>{
                ...
                const data = {
                 ...
                 const sendPostRequest = async () => {
                try {
                        const resp = await axios.post(base_url()+"/servicio-comunitario/fasetwo/update",data);
                        console.log(resp.data);
                        if (resp.data.status == 200) {
                            // list_temp_student();
                            console.log("Hola");
