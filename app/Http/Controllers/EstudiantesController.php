...
class EstudiantesController extends Controller
{
    ...
    public function index()
    {
        ...
        $estu = Estudiantes::select(
            ...
            'carreras.name',
            'estudiantes.fe_ingreso',
            'estudiantes.inicio_programa',
            'estudiantes.sexo',
            'estudiantes.sanguineo',
            'estudiantes.edo_civil',
    ...
    public function index_cc_estudiante()
    {
        $estcs = Estudiantes::select(
            ...
            'estudiantes.segundo_apellido',
            'estudiantes.email',
            'estudiantecomunitarios.semestre',
            'estudiantecomunitarios.seccion',
            'estudiantecomunitarios.turno',
            'estudiantecomunitarios.fase',
            'estudiantecomunitarios.created_at'
        )
    ...
    public function store_cc_estudiante(Request $request)
    {
        ...
        Estudiantes::where('id',$data['estudiantes_id'])->update([
            'string_sevicio_comunitario'=>"TALLER DE SERVICIO COMUNITARIO"
        ]);
